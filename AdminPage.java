...
/**
 * The AdminPage is showing the data for the game.
 * It will show user-name, rank ,and score.
 * The listButton will show the users in rank order.( high -> low )
 * The SearchButton will search users' name.
 * The Adminpage will only show 7 rows of data.
 * The back button will navigate admins back to the mainPage.
 */
